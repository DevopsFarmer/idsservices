  ...
  return (
    ...
    >
        ...
        <div className="lg:w-1/2 md:hidden text-center lg:text-left space-y-6 text-gray-700">
            <img   src='/contact.png' alt="Life Coaching" className="w-full h-full object-cover" />

          </div>

          {/* Right: Image */}
          <div className="lg:w-1/2 md:hidden pt-10 text-center w-full h-full">
          <motion.div
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ duration: 0.8, delay: 0.2 }}
          >
           <h1 className="text-4xl sm:text-7xl text-gray-700 font-serif leading-tight">
              Get in <br />
              <span className="font-signature text-white text-8xl">Touch</span>
            </h1>
            </motion.div>
          </div>
