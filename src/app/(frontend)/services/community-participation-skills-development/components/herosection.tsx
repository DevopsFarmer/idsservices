  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center">
        ...
        {/* Right: Image */}
        <div className="lg:w-1/2 md:hidden px-10 text-center pt-10 w-full h-full">
          <h1 className="text-5xl leading-[65px] font-thinker text-gray-700">
            Community <br />
            <span className=" font-signature text-white text-6xl">participation</span> and <br />
            <span className=" font-signature text-white text-6xl">skills</span> development
          </h1>
        </div>
        ...
        <div className="lg:w-1/2 hidden md:block text-center lg:text-center space-y-6 text-gray-700">
          ...
          >
            <h1 className="text-6xl leading-[65px] font-thinker text-gray-700">
              Community <br />
              <span className=" font-signature text-white text-8xl">participation</span> and <br />
              <span className=" font-signature text-white text-8xl">skills</span> development
            </h1>
          </motion.div>
        </div>
