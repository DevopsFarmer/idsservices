      ...
      <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center">
        ...
        <div className="lg:w-1/2 px-8 md:hidden text-center pt-10 w-full h-full">
          <h1 className="text-4xl sm:text-5xl font-serif text-center  leading-tight">
            ...
            <span className=" font-signature text-white text-6xl">compassionate</span> <br /> carers
          </h1>
        </div>
        ...
        <div className="lg:w-1/2 hidden md:block text-center lg:text-center space-y-6 text-gray-700">
          ...
          >
            <h1 className="text-6xl leading-[65px] font-thinker text-gray-700">
              Support <span className=" font-signature text-white text-8xl">coordination</span>
              <br /> and <br />
              in home <span className=" font-signature text-white text-8xl">support</span>
            </h1>
          </motion.div>
        </div>
