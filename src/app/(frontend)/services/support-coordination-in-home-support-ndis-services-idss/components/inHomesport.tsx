    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-semibold uppercase">In-Home Support</h2>
          <p className="mt-4 max-w-3xl mx-auto text-base md:text-lg text-white/90">
            We offer individualised services to children and adults, specifically tailored to help
            you live independently, either in your own home or in a group living arrangement. We not
            only help with all the tasks that need to be completed around your home also providing
            respectful and dignified personal care. We also help you build your own skills over
            time, to live as independently as possible.
          </p>
        </div>
        <h3 className="text-lg md:text-xl font-semibold uppercase tracking-wide mb-6 text-center md:text-center">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start gap-10">
          ...
          <div className="flex-1">
            <Image
              ...
              alt="In-home support"
              className="rounded-[0px_100px_0px_100px] w-full object-cover"
              width={1000}
              height={1000}
            />
          </div>
      ...
      <div className="w-full bg-orange-500   border-t border-gray-800 h-5 relative">
        <Image
