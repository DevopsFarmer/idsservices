    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center">
        <div className="lg:w-1/2 md:hidden text-center lg:text-left space-y-6 text-gray-700">
          <Image src="/service/service5.png" width={1667}
                height={102} alt="Life Coaching" className="w-full" />
        </div>

        {/* Right: Image */}
        <div className="lg:w-1/2 px-8 md:hidden text-center pt-10 w-full h-full">
          <h1 className="text-5xl leading-[65px] font-thinker text-gray-700">
            Respite, accommodation & supported
            <br />
            <span className=" font-signature text-white text-6xl">independent</span> living
          </h1>
        </div>
        ...
        <div className="lg:w-1/2 hidden md:block text-center lg:text-center space-y-6 text-gray-700">
          ...
          >
            <h1 className="text-6xl leading-[65px] font-thinker text-gray-700">
              Respite, accommodation & supported
              <br />
              <span className=" font-signature text-white text-8xl">independent</span> living
            </h1>
          </motion.div>
        </div>

        {/* Right: Image */}
        <div className="lg:w-1/2 hidden md:block w-full h-full">
          <Image src="/service/service5.png" alt="Life Coaching"  width={1667}
                height={102} className="w-full" />
        </div>
      </div>
      <Image
