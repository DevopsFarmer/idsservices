  ...
  return (
    <div className="text-center px-6 py-12">
      <p className="max-w-4xl mx-auto text-gray-700 text-lg md:text-xl mb-12">
        We employ our Carers based on skills and values to deliver the highest quality home and
        community care. You and your family will have ongoing support from a dedicated My Aged Care
        providers Mildura team with assistance with:
      </p>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-y-10  max-w-6xl mx-auto">
        {services.map((service, index) => (
          <div key={index} className="flex flex-col items-center text-center space-y-3">
            ...
            <p className="uppercase text-gray-800 font-semibold tracking-wide text-sm">
              {service.title}
            </p>
          </div>
        ))}
