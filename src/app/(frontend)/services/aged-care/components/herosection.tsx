    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center">
          <div className="flex flex-row-reverse md:hidden items-center px-4">
            {/* Image on Right */}
            <div className="w-1/2">
              <Image
            ...
            {/* Text on Left */}
            <div className="w-1/2 text-left pt-6">
              <h1 className="text-3xl sm:text-4xl font-serif leading-tight text-gray-600">
                Aged <span className="font-signature text-5xl text-white">care</span>
              </h1>
            </div>
          </div>
          ...
          <div className="lg:w-1/2 hidden md:block text-center lg:text-center space-y-6 text-gray-700">
            ...
            >
              <h1 className="text-7xl leading-[65px] font-thinker text-gray-700">
                Unlock Your True With Life Coaching Services
              </h1>
            </motion.div>
          </div>
          ...
          <div className="lg:w-1/2 hidden md:block w-full h-full">
            <Image src="/service/service6.png"  width={1667}
