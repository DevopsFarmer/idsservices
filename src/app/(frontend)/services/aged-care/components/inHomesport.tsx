    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          ...
          <p className="mt-4 max-w-3xl mx-auto text-base md:text-lg text-black">
            We employ carers based on skills and values to deliver the highest quality home care.
            You and your family will have ongoing support from our My Aged Care Melbourne team of
            Care Coordinators who are only a phone call away.
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-start gap-10">
          ...
          <div className="flex-1 text-white">
            ...
            <ul className=" text-black space-y-4 text-base md:text-lg">
              {[
                ...
                'Use Home Care Package registered providers',
                'We will manage your funds and pay suppliers',
              ].map((item, index) => (
          ...
          <div className="flex-1">
            <Image
              ...
              alt="In-home support"
              className="rounded-[0px_100px_0px_100px] w-[400px] object-cover"
              width={400}
              height={400}
            />
          </div>
        ...
        <div className="max-w-5xl pt-20 mx-auto flex flex-col md:flex-row items-start gap-10">
          {/* Left - Image */}
          <div className="flex-shrink-0">
            <Image
              src="/service/service8.png"
              alt="In-home support"
              className="rounded-[100px_0px_100px_0px] w-[400px] object-cover"
              width={400}
              height={400}
            />
          </div>
          ...
          <div className="flex flex-col justify-center text-white">
            <h3 className="text-lg md:text-xl font-semibold uppercase tracking-wide mb-6">
              Self-Funded Care
            </h3>
            <ul className="text-black space-y-4 text-base md:text-lg">
              {[
                'Start services immediately',
                'Access services while you wait for funding',
                'Receive services not covered by government funding',
                'A good option if you want more services than in your Home Care Package',
              ].map((item, index) => (
                <li key={index} className="flex items-start gap-2">
                  <span className="text-white">»</span>
                  <span>{item}</span>
      ...
      <div className="w-full bg-[#F47F4A]   border-t border-gray-800 h-5 relative">
        <Image
