...
const GetInTouch = () => {
  ...
  return (
    <>
      ...
      >
        <Image
          className="absolute bottom-96 rotate-180 left-0 w-full border-t border-[#f389a5] h-4"
        ...
        <Image
          className="absolute bottom-0 left-0 w-full border-t border-[#42494fe1] h-4"
