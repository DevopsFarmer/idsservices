const GetInTouch = () => {
 ...
 <header
      className="flex items-center justify-center   bg-fixed h-[400px] bg-center bg-cover"
      style={{
...
<div
  className="h-[1000px] bg-no-repeat bg-[rgb(66,73,79)] bg-bottom bg-cover overflow-hidden"
  style={{
    backgroundImage:
