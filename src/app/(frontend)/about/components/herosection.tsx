...
const HeroSection = () => {
  return (
    <>
      ...
      >
        <div className="w-full rotate-180 border-t border-gray-800 h-5 relative">
          <Image
        ...
        <div className="max-w-7xl mx-auto flex flex-col-reverse  -mb-3  bg-transparent lg:flex-row items-center ">
          ...
          <div className="lg:w-1/2 md:hidden pt-10 w-full h-full">
            ...
            >
              <h1 className="text-4xl sm:text-5xl font-serif text-center  leading-tight">
                ...
                <span className=" font-signature text-white text-6xl">compassionate</span> <br />{' '}
                carers
              </h1>
            </motion.div>
          </div>
          ...
          <div className="lg:w-1/2 hidden md:block text-center lg:text-left space-y-6 text-gray-700">
            ...
            >
              <h1 className="text-4xl sm:text-5xl font-serif text-center  leading-tight">
                Qualified, experienced &{' '}
                <span className=" font-signature text-white text-8xl">compassionate</span> <br />{' '}
                carers
              </h1>
            </motion.div>
          </div>
          ...
          {/* Right: Image */}
          <div className="lg:w-1/2 hidden md:block w-full h-full relative">
            <Image
              src="/about.png"
              alt="Life Coaching"
              width={800}
        ...
        <div className="w-full border-t h-8 relative overflow-hidden">
          <Image
