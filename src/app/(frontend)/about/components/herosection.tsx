  ...
  return (
    ...
    >
        ...
        <div className="max-w-7xl mx-auto flex flex-col-reverse  -mb-3  bg-transparent lg:flex-row items-center ">
            ...
            <img src="/about.png" alt="Life Coaching" className="w-full h-full object-cover" />

          </div>

          {/* Right: Image */}
          <div className="lg:w-1/2 md:hidden pt-10 w-full h-full">
          <motion.div
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ duration: 0.8, delay: 0.2 }}
          >
          <h1 className="text-4xl sm:text-5xl font-serif text-center  leading-tight">
              Qualified, experienced & <span className=' font-signature text-white text-6xl'>compassionate</span> <br/> carers
            </h1>
            </motion.div>
          </div>
          ...
          >
            <h1 className="text-4xl sm:text-5xl font-serif text-center  leading-tight">
              Qualified, experienced & <span className=' font-signature text-white text-8xl'>compassionate</span> <br/> carers
            </h1>
            </motion.div>
          </div>
