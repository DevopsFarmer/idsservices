...
const Footer = () => {
  return (
    <>
      <div className="w-full bg-[#42494f] h-5 border-t border-[#ffffff] relative">
        <Image
      ...
      <footer className="bg-white text-gray-700">
        ...
        <div className="relative pb-12">
          <div className="absolute -top-24 left-1/2 transform -translate-x-1/2">
            <div className="bg-white rounded-full w-36 h-36 flex items-center justify-center shadow-lg overflow-hidden">
              <Image
                ...
                width={112}
                height={112}
                className="scale-[4] object-contain"
                priority
              />
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 pt-20 pb-8 grid grid-cols-1 md:grid-cols-3 gap-8 text-sm">
            ...
            {/* Working Hours */}
            <section>
              <h3 className="text-2xl text-center tracking-widest mb-4">WORKING HOURS</h3>
              <div className="space-y-2 pl-10 text-base italic">
        ...
        <div className="bg-white border-t text-center text-xs text-gray-600 py-3 px-4">
          ...
          |
          Website by{' '}
          <a href="https://yourwebsite.com" className="text-pink-600 hover:underline">
            Your Company
          </a>
        </div>
      </footer>
